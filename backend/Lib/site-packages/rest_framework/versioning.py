...
class URLPathVersioning(BaseVersioning):
    ...
    urlpatterns = [
        url(r'^(?P<version>[v1|v2]+)/customusers/$', users_list, name='customusers-list'),
        url(r'^(?P<version>[v1|v2]+)/customusers/(?P<pk>[0-9]+)/$', users_detail, name='customusers-detail')
    ]
...
class NamespaceVersioning(BaseVersioning):
    ...
    # customusers/urls.py
    urlpatterns = [
        url(r'^/customusers/$', users_list, name='customusers-list'),
        url(r'^/customusers/(?P<pk>[0-9]+)/$', users_detail, name='customusers-detail')
    ]

    # urls.py
    urlpatterns = [
        url(r'^v1/', include('customusers.urls', namespace='v1')),
        url(r'^v2/', include('customusers.urls', namespace='v2'))
    ]
