...
class SchemaGenerator(BaseSchemaGenerator):
    ...
    def get_keys(self, subpath, method, view):
        ...
        /customusers/                   ("customusers", "list"), ("customusers", "create")
        /customusers/{pk}/              ("customusers", "read"), ("customusers", "update"), ("customusers", "delete")
        /customusers/enabled/           ("customusers", "enabled")  # custom viewset list action
        /customusers/{pk}/star/         ("customusers", "star")     # custom viewset detail action
        /customusers/{pk}/groups/       ("customusers", "groups", "list"), ("customusers", "groups", "create")
        /customusers/{pk}/groups/{pk}/  ("customusers", "groups", "read"), ("customusers", "groups", "update"), ("customusers", "groups", "delete")
        """
        ...
        if is_custom_action(action):
            # Custom action, eg "/customusers/{pk}/activate/", "/customusers/active/"
        ...
        # Default action, eg "/customusers/", "/customusers/{pk}/"
        return named_path_components + [action]
