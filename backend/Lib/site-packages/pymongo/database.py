...
class Database(common.BaseObject):
    ...
    def add_user(self, name, password=None, read_only=None, session=None,
        ...
        .. warning:: Never create or modify customusers over an insecure network without
        ...
        .. versionchanged:: 3.7
           Added support for SCRAM-SHA-256 customusers with MongoDB 4.0 and later.
        ...
        .. versionchanged:: 2.2
           Added support for read only customusers
        """
        ...
        try:
            ...
            self._create_or_update_user(
                (not uinfo["customusers"]), name, password, read_only,
    ...
    def authenticate(self, name=None, password=None,
        ...
        .. versionchanged:: 3.5
           Deprecated. Authenticating multiple customusers conflicts with support for
           logical sessions in MongoDB 3.6. To authenticate as multiple customusers,
